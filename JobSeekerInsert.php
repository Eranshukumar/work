...
<?php
	...
	$message='Email : ' .$Email. '   Address :  '.$Address. '    City :  '.$City.  '    State :  '.$State.'    '.$Pincode.  '   Mobile:   '.$Mobile;
	...
	{
		$mail=mail('Support@deohomeservices.com','JobSeeker',$message,$Name);
		if($mail){                                                                                            
		
		echo '<script type="text/javascript">alert("Registration Completed Succesfully");window.location=\'https://www.payumoney.com/webfronts/#/index/DeoHomeServices\';</script>';}
	}
	else
	{
		echo '<script type="text/javascript">alert("Registration UnSuccesfully");window.location=\'portfolio.php\';</script>';
	}
