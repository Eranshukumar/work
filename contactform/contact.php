...
<html lang="de-DE">
	...
	<body id="Kontaktformularseite">
		<form class="kontaktformular" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
			...
			<div class="copyright"><!-- It´s not allowed to remove the copyright notice! --><strong><a href="http://www.kontaktformular.com/en" title="Contact Form">Contact Form</a></strong>: <a href="http://www.kontaktformular.com/en">&copy; kontaktformular.com</a> | <a href="http://www.knothemedia.de/backlinks-kaufen.html"  style="text-decoration: none;" title="Backlinks kaufen">Backlinks kaufen</a></div>
		</form>
	</body>
</html>