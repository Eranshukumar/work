    ...
    <div class="container">
      <div class="skill-wrap clearfix">
        <div class="center wow fadeInDown">
          <h2>About <span>Deo Home Services.</span></h2>
          <p class="lead">DeoHomeServices is India’s leading service provider for home services and maintenance needs. 

		  <br>After serving more than a thousands household customers across India we have now ventured to service businesses like yours across commercial and residential establishments.
 </p>
        </div>
      ...
      <div class="team">
        <div class="center wow fadeInDown">
          <h2>Team of <span>Deo Home Services</span></h2>
          </div>
        ...
        <div class="row clearfix">
          <div class="col-md-4 col-sm-6">
            <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="media">
                <div class="pull-left">
                  <a href="#"><img class="media-object" src="images/mypicture.jpg" alt=""></a>
                </div>
