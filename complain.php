      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-right">
          <ul class="nav navbar-nav">
           ...
           <li class="active"> <li><a href="complain.php">Complains Register</a></li>
  ...
  <section id="blog" class="container">
    <div class="blog">
      <div class="row">
        ...
        <div class="panel-heading"><center><h2><span><img src="images/reg.png" width="50%"></img></span></h2></center></div>
        <div class="panel-body">
       <?php include 'comp_register.php'?>
<br><br><br><br><br>
        </div></div></div>
        <!--/.col-md-8-->
