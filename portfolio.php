      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-right">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="portfolio.php">Job Seeker</a></li>
  ...
  <section id="portfolio">
    <div class="container">
	 ...
	 <div class="panel panel-primary">
        <div class="panel-heading"><center><span><img src="images/jobreg.png" width="55%"></span></center></div>
        <div class="panel-body">
      <div class="left">
       <?php include 'jobseek/jobseeker.php'?>
      </div>
	  </div>
	  </div>
	  </div>
	  ...
	  <div class="col-md-4">
	   <div class="panel panel-primary">
        <div class="panel-heading"><center> <img src="images/login11.png" width="70%" ></img><center></div>
        <div class="panel-body">
	   <div class="center">
       <?php include 'jobseek/login.php'?>
	   <div><br><br><br><br><br><br><br><br><br><br><br><br><br><br><hr class="noscreen" /></div>
      </div>
	  </div>  
	  </div>
	  </div>
